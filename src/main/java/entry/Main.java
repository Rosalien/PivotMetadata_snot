...
//        String password         = "sno001"                    ;
        ...
        ManagementFraction securityRealm = ManagementFraction.createDefaultFraction()
                .httpInterfaceManagementInterface((iface) -> {
                    iface.allowedOrigin("http://localhost:8081");
       ...
       deployment.as(SwaggerArchive.class)
        ...
        System.out.println("-------------------------------------deployment.addAsWebInfResource-------------------------------------");
        ...
        deployment.addPackages(true, "moulinette");
        deployment.addPackage("com.rac021.jaxd.security.provider.override");

        System.out.println("-------------------------------------deployment.addAllDependencies-------------------------------------");

        /**
         * Deploy *
         */
        deployment.addAllDependencies();
        System.out.println("-------------------------------------swarm.deploy-------------------------------------");
